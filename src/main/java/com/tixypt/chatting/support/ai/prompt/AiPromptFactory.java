...
public class AiPromptFactory {
    ...
    private static final String RESPONSE_GUIDE = """
            아래 지침만 지켜 답변해 주세요.
            - 답변 본문만 작성하고, 제목이나 대괄호 같은 표시는 출력하지 않습니다.
            - 고객 질문을 그대로 반복하지 않습니다.
            - 고객에게 바로 보여 줄 수 있는 자연스러운 어투의 2~4문장으로 답변합니다.
            - 아직 확정되지 않은 내용은 단정하지 말고 상담원 확인이 필요하다고 안내합니다.
            - 주문번호나 예매 정보처럼 추가 확인이 필요한 경우 필요한 정보만 짧게 요청합니다.
            - 웹훅, 트랜잭션 ID, API, 매칭, PENDING, CONFIRMED, RESERVED, HELD, EXPIRED, 레코드 같은 IT/내부 용어를 고객 답변에 쓰지 않습니다.
            - 입금 확인, 입금 내역 확인, 예매 내역 반영, 결제 대기 상태, 예매 완료 상태, 좌석 임시 확보처럼 쉬운 말로 바꿔 답변합니다.
            - 결제 확인 정보가 필요하면 주문번호, 예매번호, 입금 시각, 입금에 사용한 주소 일부, 입금 완료 화면 중 필요한 것만 요청합니다.
            """;
